...
router.get('/', authenticate, async (req, res) => {
  try {
    ...
    if (search) {
      // 🔒 [Fixed BUG-003]: ใช้ Parameterized Query ผ่าน Prisma Template Literal เพื่อป้องกัน SQL Injection 100%
...
// PUT /api/menu/:id — 🔒 [Fixed BUG-004]: เติม requireRole('admin') เรียบร้อย
// บล็อกไม่ให้ผู้ใช้งานทั่วไป (เช่น พนักงานเสิร์ฟ) เข้ามาแก้ไขราคาและข้อมูลอาหารเองได้
