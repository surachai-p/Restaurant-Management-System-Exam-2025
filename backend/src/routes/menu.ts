...
router.get('/', authenticate, async (req, res) => {
  try {
    ...
    if (search) {
      // ⚠️ BUG-003: Parameterized query — SQL Injection vulnerability fixed
...
// PUT /api/menu/:id — ⚠️ BUG-004: requireRole('admin') added
// Any authenticated user (waiter) can update menu prices! Fixed.
